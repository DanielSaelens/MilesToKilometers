...
//		
		people.add(new Celebrity("Trump", "President"));
		people.add(new Celebrity("Margot", "Actress"));
		people.add(new Student("Joe", "Computer Science", "Colorado School of Mines"));
		people.add(new Student("Terence", "Business", "Idaho"));
		people.add(new Student("Nick", "Liberal Arts", "Aurora Community College"));
		people.add(new Student("Daniel", "Biology", "CU Boulder"));
		people.add(new Athlete("Michael Jordan", "basketball player",new int[]{1995, 1996, 1997}));
